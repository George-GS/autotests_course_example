...
def repeats(our_str):
    """
    Возвращаем символ, входящий в строку, и количество повторений символа в строке (значения отделяем постфиксом)
    :param our_str: строка
    :return: символ, входящий в строку, и количество повторений символа в строке
    """
    new_str = ''
    letter_dict = {}

    for element in our_str:
        new_str += f'{element}_{letter_dict.setdefault(element, 0) + 1}'
        letter_dict[element] += 1
