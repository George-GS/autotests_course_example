...
def everything_for_your_cat(cats_data: list):
    """
    Возвращаем из списка кортежей - строку с группировкой питомцев по владельцам
    :param cats_data: список кортежей в формате (Имя питомца, Возраст, Имя владельца, Фамилия владельца)
    :return: строка с группировкой питомцев по владельцам
    """
