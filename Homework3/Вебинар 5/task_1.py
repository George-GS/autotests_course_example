...
def letter_stat(our_str):
    """
    Возвращаем буквы, входящие в строку, и число вхождений данной буквы в строку
    :param our_str: строка
    :return: буква, входящая в строку, и число вхождений данной буквы в строку
    """
    letter_dict = {element: list(our_str).count(element) for element in list(our_str)}
